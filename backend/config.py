...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "CareerUp")
if WEBUI_NAME != "CareerUp":
    WEBUI_NAME += " (CareerUp)"

WEBUI_URL = os.environ.get("CareerUp", "http://localhost:3000")

WEBUI_FAVICON_URL = "https://careerup.com/favicon.png"
